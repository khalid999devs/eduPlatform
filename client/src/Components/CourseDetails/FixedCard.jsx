...
const FixedCard = ({ cardDetails: { id = 1, rating = 5, img, price } }) => {
  return (
    <div className='md:fixed right-[0] lg:right-[5%] xl:right-[10%] top-[15%] z-30'>
      <div className='w-auto md:w-80 lg:w-96 max-w-sm border m-5 mb-10  rounded-lg shadow bg-onPrimary-main '>
        <a href='#'>
          <img
