...
function InputBox({ replyId }) {
  ...
  return (
    <div className="inputbox flex flex-col items-start space-x-2 w-full px-5 py-3 text-center absolute bottom-0 left-0 h-fit mb-4 font-thin tracking-wide text-base rounded-xl ">
      {/* photo viewer */}
      <div
      ...
      <div className="w-full flex items-center  gap-2">
        <div
          className={`flex flex-1 items-center gap-3 p-2.5   bg-stone-800 text-white border-gray-300 flex-grow outline-none border-0 ring-[1.5px] ring-blue-500 ${
