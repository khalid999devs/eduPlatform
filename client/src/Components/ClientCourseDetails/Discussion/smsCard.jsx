        ...
        <div className='flex flex-wrap'>
          {files.map((file, id) => {
            ...
            return (
              ...
              >
                <img
                  className='aspect-square max-w-[250px] max-h-[150px] h-auto w-auto m-1 rounded-md overflow-hidden object-cover'
                  width={500}
                  height={300}
                  ...
                  {files?.length > 0
                    ? files.map((file, id) => {
                        ...
                        return (
                          ...
                          >
                            <img
                              className='aspect-square max-w-[250px] w-36 m-1 rounded-md overflow-hidden object-cover max-h-[150px] h-auto'
                              src={reqImgWrapper(file?.path)}
                              alt={file?.filename}
                            />
                          </a>
