...
const Coursecard = ({ title, short, imagefile, cPrice }) => {
  return (
    <>
      <div className="sticky z-50 top-10 right-00 my-10 flex flex-wrap justify-center items-center checkout-card-container">
        ...
        <div className="w-80 max-w-sm border m-5 mb-10  rounded-lg shadow bg-gray-800 border-gray-700 duration-100">
          <a href="#">
            {imagefile && (
              <img
                className="w-full h-56 aspect-auto rounded-t-lg object-cover"
          ...
          <div className="px-5 pb-5">
            ...
            <p className="text-left text-slate-400">{short}</p>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                See details <FaArrowRight className="inline-block" />{" "}
              </a>
            </div>
          </div>
        </div>
